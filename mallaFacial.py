...
def drawing_output(frame, coordinates_left_eye, coordinates_right_eye, alert_message, ear, head_tilt_angle):
        ...
        if results.multi_face_landmarks:
            for face_landmarks in results.multi_face_landmarks:
                ...
                if ear < adjusted_ear_thresh:
                    aux_counter += 1
                    if aux_counter >= NUM_FRAMES * 30:  # Más de 1 segundo (asumiendo 30 fps)
                ...
                frame = drawing_output(frame, coordinates_left_eye, coordinates_right_eye, alert_message, ear, head_tilt_angle)
